<?php   // FAQS APPLICAZIONE

$faqs = [
    [
        'question' => 'Come state implementando la recente decisione della Corte di giustizia dell\'Unione europea (CGUE) relativa al diritto al\'oblio?',
    ...
    [
        ...
        Puoi leggere ulteriori informazioni sulla sicurezza online, incluso come proteggere te e la tua famiglia online, nel <a href="https://www.google.com/safetycenter/">Centro Google per la sicurezza online</a>.<br><br>
        
        <a href="https://privacy.google.com">Scopri</a> quali misure adottiamo per garantire protezione e sicurezza alle tue informazioni personali, lasciando a te il controllo.<br><br>',
    ],
    [
...
<body>
    ...
    */?>
        ...
        <!-- php content -->
            ...
            <h2><?php echo $valore['question']; ?></h3>
